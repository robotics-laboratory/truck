...
void SensorPolling::task() {
    ...
    while (true) {
        ...
        float left_front_speed = enc_left_front.get_ticks_per_sec();
        float right_front_speed = enc_right_front.get_ticks_per_sec();
        float left_rear_speed = enc_left_rear.get_ticks_per_sec();
        float right_rear_speed = enc_right_front.get_ticks_per_sec();
        protocol.transmit_encoders_speed(left_front_speed, right_front_speed,
                                         left_rear_speed, right_rear_speed);
