...
class Model {
  public:
    ...
    double baseToLimitedRearVelocity(double velocity, double correct_curvature) const;
    double baseToLimitedRearAcceleration(double acceleration, double correct_curvature) const;
