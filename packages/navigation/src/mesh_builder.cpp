...
void MeshBuilder::buildSkeleton(MeshBuild& mesh_build, const geom::ComplexPolygon& polygon) {
    boost::shared_ptr<CGAL::Straight_skeleton_2<CGAL_K>> const cgal_skeleton_ptr =
