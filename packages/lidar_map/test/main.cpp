...
TEST(LidarMap, lidar_map_test) {
    const SerializerParams serializer_params {
        ...
        .bag_name = {
            .ride = "ride_sim_map_7_1",
            .cloud = "cloud_sim_map_7_1"
        }
    };
    ...
    ComplexPolygon vector_map = Map::fromGeoJson("/truck/packages/map/data/map_7.geojson").polygons()[0];
    ...
    const auto lidar_map = builder.transformClouds(filtered_poses_optimized, filtered_clouds, true)[0];
