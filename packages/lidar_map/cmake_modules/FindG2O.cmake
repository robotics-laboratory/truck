...
macro(FIND_G2O_LIBRARY MYLIBRARY MYLIBRARYNAME)
  ...
  find_library(
    ...
    PATHS ${G2O_ROOT}/lib/Debug ${G2O_ROOT}/lib $ENV{G2O_ROOT}/lib/Debug
          $ENV{G2O_ROOT}/lib
    NO_DEFAULT_PATH
  )
  ...
  find_library(
    ...
    PATHS ${G2O_ROOT}/lib/Release ${G2O_ROOT}/lib $ENV{G2O_ROOT}/lib/Release
          $ENV{G2O_ROOT}/lib NO_DEFAULT_PATH
  )
...
# G2O itself declared found if we found the core libraries and at least one
# solver
set(G2O_FOUND "NO")
