...
TEST(SDD, Constructor) {
    {
        const std::string input_path = "svg_debug_drawer/test/data/im1_in.svg";
        const std::string output_path = "svg_debug_drawer/test/data/im1_out.svg";

        sdd::SDD(input_path, output_path);
    }
    {
        const std::string output_path = "svg_debug_drawer/test/data/im2_out.svg";
...
TEST(SDD, DrawMarker) {
    {
        const std::string output_path = "svg_debug_drawer/test/data/im3_out.svg";
...
TEST(SDD, DrawPose) {
    {
        const std::string output_path = "svg_debug_drawer/test/data/im4_out.svg";
...
TEST(SDD, DrawPolyline) {
    {
        const std::string output_path = "svg_debug_drawer/test/data/im5_out.svg";
...
TEST(SDD, DrawPolygon) {
    {
        const std::string output_path = "svg_debug_drawer/test/data/im6_out.svg";
...
TEST(SDD, DrawComplexPolygon) {
    {
        const std::string output_path = "svg_debug_drawer/test/data/im7_out.svg";
