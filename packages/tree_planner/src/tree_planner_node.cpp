...
TreePlannerNode::TreePlannerNode() : Node("tree_planner") {
    ...
    slot_.occupancy_grid = this->create_subscription<nav_msgs::msg::OccupancyGrid>(
        "/occupacy_grid", 1, std::bind(&TreePlannerNode::OnGrid, this, _1));
    ...
    planner::tree_planner::TreePlannerParams tree_planner_params = {
        .max_sampling_num =
            static_cast<int>(this->declare_parameter<int>("planner.max_sampling_num", 100000)),
        .steering_dist = this->declare_parameter<double>("planner.steering_dist", 0.2),
        .sampling_range = this->declare_parameter<double>("planner.sampling_range", 4.0),
        .goal_region_radius = this->declare_parameter<double>("planner.finish_area_radius", 0.2)};
    ...
    planner_.SetParams(params_.tree_planner_params);
}
