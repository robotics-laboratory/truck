...
TEST_F(TaylorSeriesIntgratorTest, simple_func) {
    auto integrator = pure_pursuit::detail::makeTaylorSeriesIntgrator<TaylorSeriesIntgratorTest::powers>([](auto x) { return x; }, -1, 1, 100000);
...
TEST_F(TaylorSeriesIntgratorTest, complicated_func) {
    auto integrator = pure_pursuit::detail::makeTaylorSeriesIntgrator<TaylorSeriesIntgratorTest::powers>([](auto x) { return sin(x); }, 0, 1, 1000000);
