...
[[gnu::always_inline, nodiscard, gnu::pure]] inline auto sqr_dist(const Vec2<T1> &a,
...
template <class T1, class T2>
[[gnu::always_inline, nodiscard, gnu::pure]] inline auto denormalized_dist(const Line<T1> &l,
                                                                           const Vec2<T2> &p) {
    return (dot(l.normal(), p) + l.c);
}

template <class T1, class T2>
[[gnu::always_inline, nodiscard, gnu::pure]] inline auto denormalized_dist(const Vec2<T2> &p,
                                                                           const Line<T1> &l) {
